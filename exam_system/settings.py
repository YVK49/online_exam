...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "vamshikrishna8330@gmail.com"       # Replace with your Gmail
EMAIL_HOST_PASSWORD = "lhuc ekmv xwkb urez"      # Use Gmail App Password
...
# Optional: WhiteNoise storage for better performance
